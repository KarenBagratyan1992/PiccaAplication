...
class PiccaAdapter(val data: List<RowData>):RecyclerView.Adapter<PiccaAdapter.CustomViewHolder>() {



    @SuppressLint("SuspiciousIndentation")
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CustomViewHolder {
      val view = from(parent.context).inflate(R.layout.fragment_pizza,parent,false)
